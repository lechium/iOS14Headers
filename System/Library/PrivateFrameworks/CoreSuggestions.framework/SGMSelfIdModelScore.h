...
-(void)trackEventWithScalar:(unsigned long long)arg1 model:(SGMSelfIdModelType_)arg2 result:(SGMTypeSafeBool_)arg3 supervision:(SGMSelfIdSupervisionType_)arg4 extractionModelVersion:(unsigned long long)arg5 ;
-(id)init;
