...
@property (nonatomic,copy,readonly) NSString * carPlayRequestIdentifier; 
@property (nonatomic,copy,readonly) NSString * carPlayTitle; 
@property (nonatomic,copy,readonly) NSString * carPlaySubTitle; 
@property (nonatomic,copy,readonly) NSString * carPlayMessage; 
