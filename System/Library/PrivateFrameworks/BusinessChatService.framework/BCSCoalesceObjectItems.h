...
@interface BCSCoalesceObjectItems : NSObject <BCSCoalesceObjectProtocol> {
	...
	/*^block*/id _itemsCompletionBlock;

}

@property (nonatomic,copy,readonly) id itemsCompletionBlock;              //@synthesize itemsCompletionBlock=_itemsCompletionBlock - In the implementation block
