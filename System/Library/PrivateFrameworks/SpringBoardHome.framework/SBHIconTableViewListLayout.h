...
@class SBHIconAccessoryVisualConfiguration, SBHFolderIconVisualConfiguration, SBHFloatyFolderVisualConfiguration, SBHSidebarVisualConfiguration, SBHAppLibraryVisualConfiguration, SBHRootFolderVisualConfiguration, NSString;
