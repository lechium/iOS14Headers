...
@class NSMutableArray, UIView, NSMutableSet, _UIForceLevelClassifier, _UITouchForceObservable, NSObservation, NSObservationSource, NSArray, NSString, UIGestureEnvironment;
