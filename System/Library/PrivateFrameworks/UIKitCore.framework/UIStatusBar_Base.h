...
@interface UIStatusBar_Base : _UIScrollsToTopInitiatorView <UIStatusBarServerClient, UIStatusBarStateObserver> {
	...
	SCD_Struct_UI123* _localDataOverrides;
...
@property (nonatomic,readonly) SCD_Struct_UI123* localDataOverrides;                                                //@synthesize localDataOverrides=_localDataOverrides - In the implementation block
...
-(SCD_Struct_UI123*)localDataOverrides;
...
-(void)setLocalDataOverrides:(SCD_Struct_UI123*)arg1 ;
