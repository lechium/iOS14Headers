...
@interface UIKBHandwritingView : UIKBKeyView <UIGestureRecognizerDelegate> {
	...
	SCD_Struct_UI99 _previousPoint;
...
@property (assign,nonatomic) SCD_Struct_UI98 previousPoint;                                      //@synthesize previousPoint=_previousPoint - In the implementation block
...
-(void)setPreviousPoint:(SCD_Struct_UI98)arg1 ;
