...
-(void)_performCreateOperation:(id)arg1 withContext:(SCD_Struct_MF12*)arg2 ;
-(void)_performDeleteOperation:(id)arg1 withContext:(SCD_Struct_MF12*)arg2 ;
-(void)_performStoreOperation:(id)arg1 withContext:(SCD_Struct_MF12*)arg2 ;
-(void)_performAppendOperation:(id)arg1 withContext:(SCD_Struct_MF12*)arg2 ;
-(void)_performCopyOperation:(id)arg1 withContext:(SCD_Struct_MF12*)arg2 ;
