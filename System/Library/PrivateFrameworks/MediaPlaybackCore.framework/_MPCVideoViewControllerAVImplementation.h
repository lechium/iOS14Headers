...
@class AVPlayerViewController, UIViewController, NSString;

@interface _MPCVideoViewControllerAVImplementation : NSObject <MPCVideoOutput, AVPlayerViewControllerDelegate> {
