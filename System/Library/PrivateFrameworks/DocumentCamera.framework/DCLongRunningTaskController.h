...
#import <libobjc.A.dylib/DCProgressViewControllerDelegate.h>

@class NSString, UIViewController, UIWindow, NSProgress, NSDate, DCProgressViewController;
...
@property (nonatomic,retain) DCProgressViewController * progressViewController;              //@synthesize progressViewController=_progressViewController - In the implementation block
...
-(void)setProgressViewController:(DCProgressViewController *)arg1 ;
