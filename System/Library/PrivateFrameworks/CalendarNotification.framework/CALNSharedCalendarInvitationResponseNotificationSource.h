...
@protocol CALNSharedCalendarInvitationResponseNotificationDataSource, CALNNotificationManager, CALNCalendarIconIdentifierProvider, CALNSourceEventRepresentationProvider;
...
@property (nonatomic,readonly) id<CALNSharedCalendarInvitationResponseNotificationDataSource> dataSource;                //@synthesize dataSource=_dataSource - In the implementation block
...
-(id<CALNSharedCalendarInvitationResponseNotificationDataSource>)dataSource;
