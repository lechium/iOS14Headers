...
-(void)p_renderLabels:(id)arg1 labelType:(int)arg2 part:(id)arg3 positioner:(id)arg4 offset:(const tvec3<float>*)arg5 offset2DBlock:(/*^block*/id)arg6 strideBlock:(/*^block*/id)arg7 skipFirst:(BOOL)arg8 showLast:(BOOL)arg9 ;
