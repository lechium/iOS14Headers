...
-(void)drawFragment:(const TSWPLineFragment*)arg1 updateRect:(CGRect)arg2 drawingState:(const TSWPDrawingState*)arg3 runState:(SCD_Struct_TS32*)arg4 lineDrawFlags:(unsigned)arg5 ;
...
-(void)p_drawAttachmentGlyphAtPosition:(SCD_Struct_TS34)arg1 fragment:(const TSWPLineFragment*)arg2 ;
