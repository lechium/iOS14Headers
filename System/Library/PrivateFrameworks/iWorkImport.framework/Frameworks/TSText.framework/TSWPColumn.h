...
-(SCD_Struct_TS21)lineMetricsAtCharIndex:(unsigned long long)arg1 allowEndOfLine:(BOOL)arg2 ;
-(CGRect)frameBounds;
...
-(SCD_Struct_TS22)heightInfoOfLineFragmentAtIndex:(unsigned long long)arg1 ;
