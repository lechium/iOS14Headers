...
-(void*)layoutStateForLayoutTarget:(id)arg1 afterHint:(const SCD_Struct_TS29*)arg2 childHint:(id)arg3 topicNumbers:(const TSWPTopicNumberHints*)arg4 textIsVertical:(BOOL)arg5 ;
