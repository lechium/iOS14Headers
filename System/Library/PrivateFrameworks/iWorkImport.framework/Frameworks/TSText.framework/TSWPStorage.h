...
#import <TSText/TSKSearchable.h>
#import <TSText/TSSThemedObject.h>
...
@property (assign,nonatomic) SCD_Struct_TS4 hyperlinkCellID; 
...
-(NSRange)replaceCharactersInSelection:(id)arg1 withString:(id)arg2 withFlags:(unsigned)arg3 replaceTextData:(SCD_Struct_TS6*)arg4 changeSession:(id)arg5 undoTransaction:(TSWPStorageTransactionRef)arg6 outInsertedRange:(NSRange*)arg7 ;
...
-(void)insertParagraphData:(SCD_Struct_TS10)arg1 charIndex:(unsigned long long)arg2 attributeArray:(TSWPAttributeArray*)arg3 attributeIndex:(unsigned long long)arg4 undoTransaction:(TSWPStorageTransactionRef)arg5 ;
...
-(NSRange)p_replaceCharactersInLogicalSelection:(id)arg1 withString:(id)arg2 withFlags:(unsigned)arg3 replaceTextData:(SCD_Struct_TS6*)arg4 changeSession:(id)arg5 undoTransaction:(TSWPStorageTransactionRef)arg6 outInsertedRange:(NSRange*)arg7 ;
...
-(unsigned long long)listNumberForParagraphEnumerator:(const TSWPParagraphEnumerator*)arg1 numberingData:(SCD_Struct_TS11*)arg2 ;
...
-(unsigned long long)listNumberForParagraphIndex:(unsigned long long)arg1 numberingData:(SCD_Struct_TS11*)arg2 ;
