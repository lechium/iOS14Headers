...
+(SCD_Struct_TS56)lineEndPositioningOnPath:(id)arg1 atHead:(BOOL)arg2 headPoint:(CGPoint)arg3 tailPoint:(CGPoint)arg4 headLineEnd:(id)arg5 tailLineEnd:(id)arg6 stroke:(id)arg7 ;
+(id)createClippedPath:(id)arg1 headPositioning:(SCD_Struct_TS56)arg2 tailPositioning:(SCD_Struct_TS56)arg3 stroke:(id)arg4 ;
...
+(SCD_Struct_TS56)makeDefaultPositioning;
