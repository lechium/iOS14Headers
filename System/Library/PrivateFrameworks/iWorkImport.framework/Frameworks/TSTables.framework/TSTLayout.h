...
#import <TSTables/TSKSearchTarget.h>
#import <TSTables/TSWPColumnMetrics.h>
#import <TSTables/TSWPLayoutParent.h>
#import <TSTables/TSWPStorageObserver.h>

@class TSWPPadding, TSTMasterLayout, TSTLayoutHint, TSTLayoutSpaceBundle, TSWPLayout, TSTTableInfo, TSTTableModel, TSTEditingState, NSString;
...
@interface TSTLayout : TSWPTextHostLayout <TSKSearchTarget, TSWPColumnMetrics, TSWPLayoutParent, TSWPStorageObserver> {
	...
	SCD_Struct_TS94 mEditingSpillingTextRange;
...
@property (nonatomic,readonly) SCD_Struct_TS94 editingSpillingTextRange; 
...
-(SCD_Struct_TS94)editingSpillingTextRange;
...
-(void)setupContainedTextEditingLayout:(SCD_Struct_TS57)arg1 ;
-(void)p_updateCachedStyleInformationFromCellID:(SCD_Struct_TS57)arg1 ;
-(unsigned)p_naturalAlignmentForCellID:(SCD_Struct_TS57)arg1 ;
-(unsigned)p_defaultAlignmentForTableWritingDirection;
-(CGRect)computedEditingCellContentFrame;
-(BOOL)p_layoutWhollyContainsGridRange:(SCD_Struct_TS95)arg1 ;
-(CGSize)p_rangeUpAndLeftOfIntersectionRangeOfGridRange:(SCD_Struct_TS95)arg1 ;
-(CGRect)p_computeSpillingTextFrameForLayout:(id)arg1 textSize:(CGSize)arg2 editingSpillRange:(SCD_Struct_TS94*)arg3 ;
