...
@property (nonatomic,readonly) SCD_Struct_TS57 cellID; 
...
+(id)changeDescriptorWithType:(int)arg1 cellID:(SCD_Struct_TS57)arg2 cellRegion:(id)arg3 strokeRegion:(id)arg4 ;
+(id)changeDescriptorWithType:(int)arg1 ;
+(id)changeDescriptorWithType:(int)arg1 cellID:(SCD_Struct_TS57)arg2 cellRange:(SCD_Struct_TS94)arg3 ;
+(id)changeDescriptorWithType:(int)arg1 cellID:(SCD_Struct_TS57)arg2 cellRange:(SCD_Struct_TS94)arg3 strokeRange:(SCD_Struct_TS94)arg4 ;
+(id)changeDescriptorWithType:(int)arg1 cellID:(SCD_Struct_TS57)arg2 strokeRange:(SCD_Struct_TS94)arg3 ;
+(id)changeDescriptorWithType:(int)arg1 cellRange:(SCD_Struct_TS94)arg2 ;
+(id)changeDescriptorWithType:(int)arg1 strokeRange:(SCD_Struct_TS94)arg2 ;
+(id)changeDescriptorWithType:(int)arg1 cellRange:(SCD_Struct_TS94)arg2 strokeRange:(SCD_Struct_TS94)arg3 ;
+(id)changeDescriptorWithType:(int)arg1 referenceIdentifiers:(id)arg2 ;
-(void)dealloc;
-(BOOL)isEqual:(id)arg1 ;
-(SCD_Struct_TS57)cellID;
-(id)description;
-(TSTCellRegion *)cellRegion;
-(SCD_Struct_TS94)cellRange;
-(int)changeDescriptor;
-(id)initWithChangeDescriptorType:(int)arg1 andCellRegion:(id)arg2 andCellID:(SCD_Struct_TS57)arg3 andStrokeRegion:(id)arg4 andReferenceIdentifiers:(id)arg5 ;
-(TSTCellRegion *)strokeRegion;
-(TSTCellRegion *)expandedRegion;
-(SCD_Struct_TS94)strokeRange;
-(void)setExpandedRange:(SCD_Struct_TS94)arg1 ;
-(SCD_Struct_TS94)expandedRange;
