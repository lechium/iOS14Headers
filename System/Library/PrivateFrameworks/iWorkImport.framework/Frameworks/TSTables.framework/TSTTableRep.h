...
#import <TSTables/TSDTilingLayerDelegate.h>
...
@interface TSTTableRep : TSWPTextHostRep <TSDTilingLayerDelegate, UITextFieldDelegate> {
	...
	SCD_Struct_TS94 mDirtyCellRange;
	...
	SCD_Struct_TS57 mControlCellID;
	SCD_Struct_TS57 mRatingsDragCellID;
	...
	SCD_Struct_TS94 mZoomToEditVisibleCellRange;
	...
	SCD_Struct_TS57 mEditingHyperlinkCellID;
...
@property (assign,nonatomic) SCD_Struct_TS57 ratingsDragCellID; 
...
-(id)editorSelection;
-(void)contentsRectForCellRangeAcrossSpaces:(SCD_Struct_TS94)arg1 contentsCenterInfo:(SCD_Struct_TS476*)arg2 canvasFrame:(CGRect*)arg3 contentsRect:(CGRect*)arg4 ;
-(CGRect)deviceBoundsForCellRange:(SCD_Struct_TS94)arg1 ;
-(void)validateVisibleRect;
-(id<TSTTableChromeProvider>)tableChrome;
-(void)dirtyCellRange:(SCD_Struct_TS94)arg1 ;
-(void)setNeedsDisplayInCellRange:(SCD_Struct_TS94)arg1 ;
...
-(void)invalidateCellRange:(SCD_Struct_TS94)arg1 fittingRange:(SCD_Struct_TS94)arg2 invalidateSize:(BOOL)arg3 ;
...
-(void)asyncPostTextChangedInRange:(SCD_Struct_TS94)arg1 strokeRange:(SCD_Struct_TS94)arg2 ;
-(void)invalidateEditingCell;
-(CGRect)canvasBoundsForCellRange:(SCD_Struct_TS94)arg1 ;
-(CGRect)boundsForCellSelection:(SCD_Struct_TS57)arg1 ;
...
-(void)invalidateCellRange:(SCD_Struct_TS94)arg1 ;
...
-(SCD_Struct_TS57)ratingsDragCellID;
-(void)setRatingsDragCellID:(SCD_Struct_TS57)arg1 ;
