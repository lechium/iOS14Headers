...
#import <TSTables/TSKChangeSourceObserver.h>
...
@interface TSTMasterLayout : NSObject <TSKChangeSourceObserver> {
	...
	SCD_Struct_TS94 mDynamicFontColorCellRange;
	SCD_Struct_TS94 mDynamicHidingRowsCols;
	int mDynamicHidingRowsColsDirection;
	SCD_Struct_TS94 mDynamicHidingContent;
	SCD_Struct_TS94 mDynamicHidingText;
	TSDInfoGeometry* mDynamicInfoGeometry;
	BOOL mDynamicRepResize;
	BOOL mDynamicRepressFrozenHeader;
	BOOL mDynamicResizingColumns;
	SCD_Struct_TS94 mDynamicResizingColumnRange;
	double mDynamicResizingColumnAdjustment;
	BOOL mDynamicResizingRows;
	SCD_Struct_TS94 mDynamicResizingRowRange;
	double mDynamicResizingRowAdjustment;
	SCD_Struct_TS94 mDynamicRevealingRowsCols;
	...
	SCD_Struct_TS57 mDynamicSuppressingConditionalStylesCellID;
...
@property (nonatomic,readonly) SCD_Struct_TS94 dynamicFontColorCellRange; 
...
@property (nonatomic,readonly) SCD_Struct_TS94 dynamicResizingColumnRange; 
@property (nonatomic,readonly) double dynamicResizingColumnAdjustment; 
@property (nonatomic,readonly) BOOL dynamicResizingRows; 
@property (nonatomic,readonly) SCD_Struct_TS94 dynamicResizingRowRange; 
...
@property (nonatomic,readonly) SCD_Struct_TS57 dynamicSuppressingConditionalStylesCellID; 
...
-(SCD_Struct_TS57)modelCellIDForLayoutCellID:(SCD_Struct_TS57)arg1 ;
-(SCD_Struct_TS57)layoutCellIDForModelCellID:(SCD_Struct_TS57)arg1 ;
-(unsigned)tableAreaForCellID:(SCD_Struct_TS57)arg1 ;
-(BOOL)isDynamicallyChangingContent;
-(BOOL)cell:(id*)arg1 forCellID:(SCD_Struct_TS57)arg2 ;
-(SCD_Struct_TS57)dynamicSuppressingConditionalStylesCellID;
...
-(BOOL)isDynamicallyHidingRowsColsCellID:(SCD_Struct_TS57)arg1 ;
-(BOOL)isDynamicallyResizingCellID:(SCD_Struct_TS57)arg1 ;
-(BOOL)isDynamicallyHidingContentOfCellID:(SCD_Struct_TS57)arg1 ;
-(BOOL)isDynamicallyHidingTextOfCellID:(SCD_Struct_TS57)arg1 ;
-(BOOL)isDynamicallyChangingFontColorOfCellID:(SCD_Struct_TS57)arg1 ;
-(id)validateCellForDrawing:(SCD_Struct_TS57)arg1 cell:(id)arg2 contents:(id)arg3 wrap:(BOOL)arg4 verticalAlignment:(unsigned)arg5 padding:(id)arg6 layoutCacheFlags:(int)arg7 pageNumber:(unsigned long long)arg8 pageCount:(unsigned long long)arg9 ;
-(id)newTextEngineForCell:(id)arg1 atCellID:(SCD_Struct_TS57)arg2 ;
-(BOOL)isDynamicallyChangingRowCount;
-(int)dynamicRowAdjustment;
-(double)tableNameHeight;
-(id)accountingParagraphStylePropertyMapForCell:(id)arg1 atCellID:(SCD_Struct_TS57)arg2 ;
-(void)setTableInfo:(TSTTableInfo *)arg1 ;
-(NSIndexSet *)visibleRowIndices;
-(NSIndexSet *)visibleColumnIndices;
-(void)addChangeDescriptorWithType:(int)arg1 andCellRange:(SCD_Struct_TS94)arg2 ;
...
-(UIEdgeInsets)defaultPaddingForCellID:(SCD_Struct_TS57)arg1 ;
-(UIEdgeInsets)paddingForCellID:(SCD_Struct_TS57)arg1 ;
-(double)fontHeightOfParagraphStyle:(id)arg1 ;
-(void)invalidateBandedFill;
-(SCD_Struct_TS57)modelCellIDForStrokesOfLayoutCellID:(SCD_Struct_TS57)arg1 ;
...
-(void)updateDynamicHidingRowsCols:(int)arg1 hidingCellRange:(SCD_Struct_TS94)arg2 ;
...
-(void)addChangeDescriptorWithType:(int)arg1 andCellRange:(SCD_Struct_TS94)arg2 andStrokeRange:(SCD_Struct_TS94)arg3 ;
...
-(void)queueCellForValidation:(SCD_Struct_TS94)arg1 cell:(id)arg2 mergeRange:(SCD_Struct_TS94)arg3 wrap:(BOOL)arg4 verticalAlignment:(unsigned)arg5 padding:(id)arg6 prop:(BOOL)arg7 layoutCacheFlags:(int)arg8 ;
-(void)p_validateFittingInfoForCellID:(SCD_Struct_TS57)arg1 inMergeRange:(SCD_Struct_TS94)arg2 ;
-(SCD_Struct_TS57)p_validateFittingInfoForEmptyCellsBetween:(SCD_Struct_TS57)arg1 andCellID:(SCD_Struct_TS57)arg2 inRange:(SCD_Struct_TS94)arg3 ;
-(void)validateFittingInfoForCell:(id)arg1 cellID:(SCD_Struct_TS57)arg2 mergeRange:(SCD_Struct_TS94)arg3 setFitting:(BOOL)arg4 ;
-(void)p_validateFittingInfoForEmptyCellsOnSingleRowBetween:(SCD_Struct_TS57)arg1 andEndCellID:(SCD_Struct_TS57)arg2 ;
-(TSTDupContentCache *)dupContentCache;
-(void)validateFittingInfoWithCellRange:(SCD_Struct_TS94)arg1 ;
...
-(void)clearModelHeightWidthCacheForCellRange:(SCD_Struct_TS94)arg1 ;
...
-(void)updateDynamicResize:(int)arg1 resizingRange:(SCD_Struct_TS94)arg2 resizeAdjustment:(double)arg3 ;
...
-(void)updateDynamicHidingContent:(SCD_Struct_TS94)arg1 ;
-(void)updateDynamicHidingText:(SCD_Struct_TS94)arg1 ;
-(void)updateDynamicInfoGeometry:(id)arg1 ;
-(void)updateDynamicRevealingRowsCols:(int)arg1 revealingCellRange:(SCD_Struct_TS94)arg2 ;
-(void)updateDynamicContentDelegate:(id)arg1 ;
-(void)updateDynamicFontColor:(id)arg1 andRange:(SCD_Struct_TS94)arg2 ;
-(void)updateDynamicRowSwapDelegate:(id)arg1 ;
-(void)updateDynamicColumnSwapDelegate:(id)arg1 ;
-(void)updateDynamicSuppressingConditionalStylesCellID:(SCD_Struct_TS57)arg1 ;
...
-(SCD_Struct_TS94)dynamicFontColorCellRange;
...
-(SCD_Struct_TS94)dynamicResizingColumnRange;
-(BOOL)dynamicResizingRows;
-(double)dynamicResizingRowAdjustment;
-(SCD_Struct_TS94)dynamicResizingRowRange;
