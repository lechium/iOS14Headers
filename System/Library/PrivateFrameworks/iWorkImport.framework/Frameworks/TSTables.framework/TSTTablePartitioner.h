...
-(SCD_Struct_TS94)measureCellRangeForNextPartitionOfSize:(CGSize)arg1 previousHint:(id)arg2 horizontally:(BOOL)arg3 ;
...
-(id)hintCacheKeyForPartitioningPass:(id)arg1 andHintID:(SCD_Struct_TS57)arg2 ;
