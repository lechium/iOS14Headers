...
@interface TSTTableRepProcessChangesActions : NSObject {
	...
	SCD_Struct_TS94 dirtyCellRange;
	SCD_Struct_TS94 dirtyStrokeRange;

}

@property (assign,nonatomic) SCD_Struct_TS94 dirtyCellRange; 
@property (assign,nonatomic) SCD_Struct_TS94 dirtyStrokeRange; 
...
-(void)setDirtyCellRange:(SCD_Struct_TS94)arg1 ;
-(void)setDirtyStrokeRange:(SCD_Struct_TS94)arg1 ;
-(SCD_Struct_TS94)dirtyCellRange;
-(SCD_Struct_TS94)dirtyStrokeRange;
