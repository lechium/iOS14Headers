...
@interface TSTMergeRegionMap : TSPObject {
	...
	SCD_Struct_TS94 mUnionedMergeRange;

}
+(id)mergeRegionMapFromMap:(id)arg1 intersectingRange:(SCD_Struct_TS94)arg2 ;
-(BOOL)remove:(SCD_Struct_TS94)arg1 ;
-(BOOL)find:(SCD_Struct_TS94)arg1 ;
-(BOOL)insert:(SCD_Struct_TS94)arg1 ;
-(unsigned long long)count;
-(id)iterator;
-(id)initWithContext:(id)arg1 ;
-(id)description;
-(SCD_Struct_TS94)mergedRangeForCellID:(SCD_Struct_TS57)arg1 ;
-(BOOL)partiallyIntersectsCellRange:(SCD_Struct_TS94)arg1 ;
-(id)initRegionMapFromMap:(id)arg1 rowRemapping:(id)arg2 ;
-(SCD_Struct_TS94)unionedMergeRange;
-(id)mergedGridIndicesForDimension:(int)arg1 ;
-(id)initRegionMapFromMap:(id)arg1 intersectingRange:(SCD_Struct_TS94)arg2 ;
