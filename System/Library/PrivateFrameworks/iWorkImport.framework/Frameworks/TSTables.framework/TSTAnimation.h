...
+(id)newAnimationWithLayout:(id)arg1 andCellRange:(SCD_Struct_TS94)arg2 ;
...
-(SCD_Struct_TS94)cellRangeAtIndex:(unsigned long long)arg1 ;
...
-(void)addCellRange:(SCD_Struct_TS94)arg1 ;
