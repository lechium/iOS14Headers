...
+(unsigned)tableAreaForCellID:(SCD_Struct_TS30)arg1 inTableWithHeaderColumns:(unsigned short)arg2 headerRows:(unsigned short)arg3 footerRows:(unsigned short)arg4 totalRows:(unsigned short)arg5 ;
+(SCD_Struct_TS32)cellRangeForTableArea:(unsigned)arg1 givenTableSize:(SCD_Struct_TS31)arg2 numberOfHeaderRows:(unsigned short)arg3 numberOfFooterRows:(unsigned short)arg4 numberOfHeaderColumns:(unsigned short)arg5 ;
-(unsigned short)numberOfRows;
-(SCD_Struct_TS32)range;
-(NSString *)tableName;
-(id)dataStore;
-(void)validate;
...
-(BOOL)useBandedFill;
-(unsigned)tableAreaForCellID:(SCD_Struct_TS30)arg1 ;
-(int)defaultCell:(id)arg1 forTableArea:(unsigned)arg2 ;
-(id)bandedFillObject;
-(SCD_Struct_TS32)bodyRowRange;
...
-(SCD_Struct_TS32)headerRowRange;
-(SCD_Struct_TS32)footerRowRange;
-(SCD_Struct_TS32)headerColumnRange;
-(SCD_Struct_TS32)bodyColumnRange;
-(void)defaultStrokesForCellID:(SCD_Struct_TS30)arg1 inTableWithHeaderColumns:(unsigned short)arg2 headerRows:(unsigned short)arg3 footerRows:(unsigned short)arg4 totalColumns:(unsigned short)arg5 totalRows:(unsigned short)arg6 tableArea:(unsigned)arg7 outTopStroke:(id*)arg8 outLeftStroke:(id*)arg9 outBottomStroke:(id*)arg10 outRightStroke:(id*)arg11 ;
...
-(void)p_scaleStrokesOnCell:(id)arg1 atCellID:(SCD_Struct_TS30)arg2 transformedObjects:(id)arg3 scale:(double)arg4 ;
...
-(SCD_Struct_TS32)cellRangeForTableArea:(unsigned)arg1 ;
...
-(void)defaultStrokesForCellID:(SCD_Struct_TS30)arg1 outTopStroke:(id*)arg2 outLeftStroke:(id*)arg3 outBottomStroke:(id*)arg4 outRightStroke:(id*)arg5 ;
-(id)cellRegionWithConditionalStyleMatchingCell:(SCD_Struct_TS30)arg1 ;
-(void)moveCalcEngineReferencesFromSourceTable:(CFUUIDRef)arg1 sourceRange:(SCD_Struct_TS32)arg2 sourceOffset:(SCD_Struct_TS33)arg3 ;
-(void)validateStyles;
-(void)private_validateMergeCellsPedantically;
-(SCD_Struct_TS32)minPopulatedCellRange;
