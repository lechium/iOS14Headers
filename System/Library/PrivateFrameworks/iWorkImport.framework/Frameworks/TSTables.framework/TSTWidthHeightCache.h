...
-(BOOL)moveRowsFrom:(SCD_Struct_TS94)arg1 toRow:(unsigned short)arg2 ;
-(BOOL)moveColsFrom:(SCD_Struct_TS94)arg1 toCol:(unsigned char)arg2 ;
...
-(void)resetWidthsHeightsForRange:(SCD_Struct_TS94)arg1 ;
...
-(BOOL)setFitDims:(CGSize)arg1 forCellID:(SCD_Struct_TS57)arg2 ;
-(BOOL)setFitWidth:(double)arg1 forCellID:(SCD_Struct_TS57)arg2 ;
-(BOOL)setFitHeight:(double)arg1 forCellID:(SCD_Struct_TS57)arg2 ;
-(unsigned long long)numModelColumnWidths;
-(unsigned long long)numModelRowHeights;
-(BOOL)resetModelCacheRange:(SCD_Struct_TS94)arg1 ;
...
-(void)resetAllRow;
-(void)resetAllCol;
-(void)resetRowHeightForCell:(SCD_Struct_TS57)arg1 ;
-(void)resetFitHeightForCellID:(SCD_Struct_TS57)arg1 ;
-(void)setNumsRows:(unsigned short)arg1 andNumCols:(unsigned char)arg2 ;
-(BOOL)verifyDims:(CGSize)arg1 forCellID:(SCD_Struct_TS57)arg2 ;
