...
-(SCD_Struct_TS18)metalPoint2DForAttribute:(id)arg1 atIndex:(unsigned long long)arg2 ;
-(void)setMetalPoint2D:(SCD_Struct_TS18)arg1 forAttribute:(id)arg2 atIndex:(unsigned long long)arg3 ;
-(SCD_Struct_TS19)metalPoint3DForAttribute:(id)arg1 atIndex:(unsigned long long)arg2 ;
-(void)setMetalPoint3D:(SCD_Struct_TS19)arg1 forAttribute:(id)arg2 atIndex:(unsigned long long)arg3 ;
-(SCD_Struct_TS20)metalPoint4DForAttribute:(id)arg1 atIndex:(unsigned long long)arg2 ;
-(void)setMetalPoint4D:(SCD_Struct_TS20)arg1 forAttribute:(id)arg2 atIndex:(unsigned long long)arg3 ;
...
-(BOOL)p_setAttributeUpdateData:(SCD_Struct_TS29*)arg1 fromAttribute:(id)arg2 ;
