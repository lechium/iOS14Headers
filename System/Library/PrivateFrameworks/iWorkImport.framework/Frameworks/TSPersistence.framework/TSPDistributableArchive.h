...
@interface TSPDistributableArchive : NSObject {
	...
	SCD_Struct_TS264 _archivedVersions;

}
+(BOOL)_checkFileHeader:(const char*)arg1 length:(unsigned long long)arg2 dffVersion:(unsigned short*)arg3 archivedVersions:(SCD_Struct_TS264*)arg4 defaultObjectVersion:(unsigned*)arg5 hasDescriptors:(BOOL*)arg6 hasToc:(BOOL*)arg7 otherDataLength:(unsigned*)arg8 closedCleanly:(BOOL*)arg9 ;
+(id)_newStringFromUtf8DataInStream:(id)arg1 length:(unsigned long long)arg2 ;
+(BOOL)readArchivedVersionsFromStream:(id)arg1 versions:(SCD_Struct_TS264*)arg2 error:(id*)arg3 ;
...
-(SCD_Struct_TS264)archivedVersions;
