...
@property (nonatomic,readonly) BOOL didPlayAcrossSlides;                 //@synthesize didPlayAcrossSlides=_didPlayAcrossSlides - In the implementation block
