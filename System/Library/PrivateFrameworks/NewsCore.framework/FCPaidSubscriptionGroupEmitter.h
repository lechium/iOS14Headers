...
@property (nonatomic,copy) id<FCFeedGroupInsertionDescriptor> insertionDescriptor;              //@synthesize insertionDescriptor=_insertionDescriptor - In the implementation block
...
-(void)setInsertionDescriptor:(id<FCFeedGroupInsertionDescriptor>)arg1 ;
