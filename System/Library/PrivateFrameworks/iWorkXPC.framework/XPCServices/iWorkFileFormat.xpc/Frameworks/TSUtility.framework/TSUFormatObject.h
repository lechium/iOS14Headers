...
@property (nonatomic,readonly) SCD_Struct_TS68 formatStruct; 
...
-(id)initWithTSUFormatFormatStruct:(SCD_Struct_TS68)arg1 ;
-(id)initWithTSUFormatFormatStruct:(SCD_Struct_TS68)arg1 useExpandedContents:(BOOL)arg2 ;
-(SCD_Struct_TS68)formatStruct;
-(BOOL)useExpandedContents;
-(void)p_setFormatStruct:(SCD_Struct_TS68)arg1 ;
@end
