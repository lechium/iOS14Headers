...
-(void)_processMotionSample:(const SCD_Struct_BW93*)arg1 gravity:(const SCD_Struct_Fi128*)arg2 motionTimestamp:(double)arg3 frameTimestamp:(SCD_Struct_BW8)arg4 metadata:(id)arg5 ;
