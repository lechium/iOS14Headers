...
-(SCD_Struct_MT55)heapBufferSizeAndAlignWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2 ;
...
-(void)getDefaultSamplePositions:(SCD_Struct_MT56*)arg1 count:(unsigned long long)arg2 ;
...
-(SCD_Struct_MT55)heapTextureSizeAndAlignWithDescriptor:(id)arg1 ;
