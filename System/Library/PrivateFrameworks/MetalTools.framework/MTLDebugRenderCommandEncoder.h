...
@interface MTLDebugRenderCommandEncoder : MTLToolsRenderCommandEncoder {
	...
	SCD_Struct_MT108 _vertexBuffers[36];
	SCD_Struct_MT108 _vertexTextures[128];
	SCD_Struct_MT108 _vertexSamplers[16];
	SCD_Struct_MT108 _fragmentBuffers[31];
	SCD_Struct_MT108 _fragmentTextures[128];
	SCD_Struct_MT108 _fragmentSamplers[16];
	SCD_Struct_MT108 _tileBuffers[31];
	SCD_Struct_MT108 _tileTextures[128];
	SCD_Struct_MT108 _tileSamplers[16];
	SCD_Struct_MT108 _threadgroupMemoryArguments[31];
	...
	SCD_Struct_MT108 _tessellationFactorBufferArgument;
...
@property (nonatomic,readonly) SCD_Struct_MT108 tessellationFactorBufferArgument;                      //@synthesize tessellationFactorBufferArgument=_tessellationFactorBufferArgument - In the implementation block
...
-(void)dispatchThreadsPerTile:(SCD_Struct_MT109)arg1 ;
...
-(SCD_Struct_MT108)tessellationFactorBufferArgument;
