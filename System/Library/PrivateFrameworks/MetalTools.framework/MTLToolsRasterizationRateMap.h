...
@property (readonly) SCD_Struct_MT55 parameterBufferSizeAndAlign; 
...
-(SCD_Struct_MT55)parameterBufferSizeAndAlign;
-(SCD_Struct_MT0)physicalSizeForLayer:(unsigned long long)arg1 ;
-(SCD_Struct_MT56)mapScreenToPhysicalCoordinates:(SCD_Struct_MT56)arg1 forLayer:(unsigned long long)arg2 ;
-(SCD_Struct_MT56)mapPhysicalToScreenCoordinates:(SCD_Struct_MT56)arg1 forLayer:(unsigned long long)arg2 ;
