...
+(id)buildWithIdentifier:(id)arg1 visibleName:(id)arg2 hostname:(id)arg3 port:(id)arg4 username:(id)arg5 authenticated:(id)arg6 isMailEnabled:(id)arg7 areNotesEnabled:(id)arg8 ;
