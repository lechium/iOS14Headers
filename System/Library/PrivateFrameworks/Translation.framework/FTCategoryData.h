...
-(id)initWithFlatbuffData:(id)arg1 root:(const CategoryData*)arg2 verify:(BOOL)arg3 ;
-(Offset<siri::speech::schema_fb::CategoryData>)addObjectToBuffer:(FlatBufferBuilder*)arg1 ;
-(id)flatbuffData;
-(id)initWithFlatbuffData:(id)arg1 ;
-(id)initAndVerifyWithFlatbuffData:(id)arg1 ;
-(id)initWithFlatbuffData:(id)arg1 root:(const CategoryData*)arg2 ;
