...
#import <libobjc.A.dylib/SXLineComponent.h>

@protocol SXLineComponent <SXComponent,SXLineComponentProperties>
@end


@class NSString, SXComponentConditions, SXJSONDictionary, SXComponentClassification, SXJSONArray, SXComponentAnimation, SXStrokeStyle;
