...
-(SCD_Struct_HD84)_queue_defaultCollectionStateForType:(id)arg1 ;
...
-(SCD_Struct_HD84)_queue_collectionStateForType:(id)arg1 ;
...
-(void)_queue_updateLegacyDataCollector:(id)arg1 forChangeFromState:(SCD_Struct_HD84)arg2 toState:(SCD_Struct_HD84)arg3 type:(id)arg4 ;
...
-(id)_dataAggregatorConfigurationForCollectorState:(SCD_Struct_HD84)arg1 ;
@end
