...
-(id)smartHitTestResultForImagePoint:(float)arg1 ;
-(4)normalizedImagePointForScreenPoint:(CGSize)arg1 viewportSize:(long long)arg2 ;
-(id)hitTestOnPlaneWithWorldTransform:(SCD_Struct_AR1)arg1 forImagePoint:(float)arg2 ;
-(ARCamera *)camera;
