...
@property (nonatomic,retain) UIImageView * nibOutlineImageView;                  //@synthesize nibOutlineImageView=_nibOutlineImageView - In the implementation block
...
-(UIImageView *)nibOutlineImageView;
...
-(void)setNibOutlineImageView:(UIImageView *)arg1 ;
@end
