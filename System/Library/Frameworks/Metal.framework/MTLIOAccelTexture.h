...
@property (readonly) SCD_Struct_MT58 swizzle; 
...
-(void)makeAliasable;
-(id)initWithTexture:(id)arg1 pixelFormat:(unsigned long long)arg2 textureType:(unsigned long long)arg3 levels:(NSRange)arg4 slices:(NSRange)arg5 swizzle:(SCD_Struct_MT58)arg6 ;
...
-(void)replaceRegion:(SCD_Struct_MT51)arg1 mipmapLevel:(unsigned long long)arg2 withBytes:(const void*)arg3 bytesPerRow:(unsigned long long)arg4 ;
-(unsigned long long)numFaces;
-(BOOL)isFramebufferOnly;
-(void)copyFromPixels:(const void*)arg1 rowBytes:(unsigned long long)arg2 imageBytes:(unsigned long long)arg3 toSlice:(unsigned long long)arg4 mipmapLevel:(unsigned long long)arg5 origin:(SCD_Struct_MT31)arg6 size:(SCD_Struct_MT31)arg7 ;
...
-(void)getBytes:(void*)arg1 bytesPerRow:(unsigned long long)arg2 fromRegion:(SCD_Struct_MT51)arg3 mipmapLevel:(unsigned long long)arg4 ;
...
-(BOOL)isShareable;
-(id)initWithTextureInternal:(id)arg1 pixelFormat:(unsigned long long)arg2 textureType:(unsigned long long)arg3 levels:(NSRange)arg4 slices:(NSRange)arg5 swizzle:(SCD_Struct_MT58)arg6 compressedView:(BOOL)arg7 ;
-(id)newSharedTextureHandle;
-(void)copyFromSlice:(unsigned long long)arg1 mipmapLevel:(unsigned long long)arg2 origin:(SCD_Struct_MT31)arg3 size:(SCD_Struct_MT31)arg4 toPixels:(void*)arg5 rowBytes:(unsigned long long)arg6 imageBytes:(unsigned long long)arg7 ;
