...
@property (setter=_setResultPlayerItem:,nonatomic,retain) AVPlayerItem * _resultPlayerItem;              //@synthesize _resultPlayerItem=__resultPlayerItem - In the implementation block
