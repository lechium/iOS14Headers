...
-(id)connection;
-(void)setMapMatchingRouteHint:(SCD_Struct_CL54*)arg1 count:(int)arg2 routingType:(int)arg3 stepType:(int)arg4 ;
...
-(unsigned char)getGroundAltitudeForBundleID:(const CFStringRef)arg1 orBundlePath:(const CFStringRef)arg2 location:(id)arg3 groundAltitude:(SCD_Struct_CL56*)arg4 ;
...
-(unsigned char)getGyroCalibrationDatabaseBiasFit:(SCD_Struct_CM29*)arg1 atTemperature:(float)arg2 ;
...
-(unsigned char)compassCalibrationDatabaseGetBias:(SCD_Struct_CL58*)arg1 magneticField:(SCD_Struct_CM1)arg2 acceleration:(SCD_Struct_CM1)arg3 ;
...
-(unsigned char)getLocationForBundleID:(const CFStringRef)arg1 orBundlePath:(const CFStringRef)arg2 dynamicAccuracyReductionEnabled:(unsigned char)arg3 allowsAlteredAccessoryLocations:(unsigned char)arg4 location:(SCD_Struct_CL59*)arg5 ;
