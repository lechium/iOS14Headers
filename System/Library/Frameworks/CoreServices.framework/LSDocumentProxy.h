...
@interface LSDocumentProxy : LSResourceProxy <NSSecureCoding> {
	...
	SCD_Struct_LS1 _sourceAuditToken;
...
@property (nonatomic,readonly) const SCD_Struct_LS1* sourceAuditToken; 
@property (nonatomic,readonly) BOOL sourceIsManaged; 
@property (nonatomic,readonly) const SCD_Struct_LS1* managedSourceAuditToken; 
+(id)documentProxyForName:(id)arg1 type:(id)arg2 MIMEType:(id)arg3 isContentManaged:(BOOL)arg4 sourceAuditToken:(const SCD_Struct_LS1*)arg5 ;
+(id)documentProxyForName:(id)arg1 type:(id)arg2 MIMEType:(id)arg3 managedSourceAuditToken:(const SCD_Struct_LS1*)arg4 ;
+(id)documentProxyForName:(id)arg1 type:(id)arg2 MIMEType:(id)arg3 sourceIsManaged:(BOOL)arg4 ;
+(id)documentProxyForURL:(id)arg1 isContentManaged:(BOOL)arg2 sourceAuditToken:(const SCD_Struct_LS1*)arg3 ;
+(id)documentProxyForURL:(id)arg1 managedSourceAuditToken:(const SCD_Struct_LS1*)arg2 ;
...
-(id)initWithURL:(id)arg1 name:(id)arg2 type:(id)arg3 MIMEType:(id)arg4 isContentManaged:(BOOL)arg5 sourceAuditToken:(const SCD_Struct_LS1*)arg6 ;
...
-(BOOL)isImageOrVideo;
-(const SCD_Struct_LS1*)sourceAuditToken;
-(NSString *)containerOwnerApplicationIdentifier;
-(id)availableClaimBindingsReturningError:(id*)arg1 ;
-(optional<LaunchServices::BindingEvaluator>*)_bindingEvaluatorWithAuditToken:(const SCD_Struct_LS1*)arg1 ;
-(const SCD_Struct_LS1*)managedSourceAuditToken;
-(id)debugDescription;
-(NSURL *)URL;
