...
+ (id)createFromProvider:(id)arg1;	// IMP=0x000000010010830c
+ (id)noPeersState:(id)arg1;	// IMP=0x00000001001081d8
- (void).cxx_destruct;	// IMP=0x0000000100108178
...
- (_Bool)unwrapKey:(id)arg1 fromShares:(id)arg2 error:(id *)arg3;	// IMP=0x000000010010744c
- (id)findPeersMissingTLKSharesFor:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100105eb0
- (id)description;	// IMP=0x0000000100105d70
- (id)initWithPeerProviderID:(id)arg1 essential:(_Bool)arg2 selfPeers:(id)arg3 selfPeersError:(id)arg4 trustedPeers:(id)arg5 trustedPeersError:(id)arg6;	// IMP=0x0000000100105af8
