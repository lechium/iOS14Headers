...
@interface OTVouchWithRecoveryKeyOperation : CKKSGroupOperation <OctagonStateTransitionOperationProtocol>
{
    ...
    NSString *_recoveryKey;	// 72 = 0x48
    NSOperation *_finishOp;	// 80 = 0x50
}

- (void).cxx_destruct;	// IMP=0x00000001000ca6e0
...
- (void)proceedWithKeys:(id)arg1 tlkShares:(id)arg2 salt:(id)arg3;	// IMP=0x00000001000ca3a0
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00000001000ca1d4
- (void)groupStart;	// IMP=0x00000001000c9c64
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 recoveryKey:(id)arg4;	// IMP=0x00000001000c9b48
