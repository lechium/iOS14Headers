...
- (void).cxx_destruct;	// IMP=0x0000000100092728
...
- (void)cancel;	// IMP=0x0000000100092578
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x0000000100092020
- (void)trigger;	// IMP=0x0000000100091f54
- (void)_onqueueTimerTick;	// IMP=0x0000000100091c24
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x0000000100091b48
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x0000000100091ac0
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x00000001000918dc
- (id)makeOperationDependency;	// IMP=0x0000000100091800
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x0000000100091770
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 expontialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x000000010009158c
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x00000001000914e4
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x0000000100091464
