...
- (void).cxx_destruct;	// IMP=0x000000010016ef84
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010016e5c0
- (unsigned long long)hash;	// IMP=0x000000010016e098
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010016d908
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010016d244
- (void)copyTo:(id)arg1;	// IMP=0x000000010016cc04
- (void)writeTo:(id)arg1;	// IMP=0x000000010016c668
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010016c660
- (id)dictionaryRepresentation;	// IMP=0x000000010016bad0
- (id)description;	// IMP=0x000000010016ba1c
