...
- (void)handleTimeout;	// IMP=0x00000001000583f8
- (void)handlePluginDisposeComplete:(id)arg1;	// IMP=0x00000001000582e0
- (void)enterWithSession:(id)arg1;	// IMP=0x0000000100058000
- (id)init;	// IMP=0x0000000100057fb4
