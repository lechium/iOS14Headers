...
- (void).cxx_destruct;	// IMP=0x0000000100005620
...
- (void)_cancelFireRequests;	// IMP=0x0000000100005500
- (void)cancelPreviousFireRequests;	// IMP=0x0000000100005474
@property(readonly, nonatomic) _Bool isScheduledToFire;
- (void)callTargetSelector;	// IMP=0x00000001000051e8
- (void)fireImmediately;	// IMP=0x00000001000050d4
- (void)requestFire;	// IMP=0x0000000100004d90
- (void)dealloc;	// IMP=0x0000000100004cd8
- (id)initWithTarget:(id)arg1 selector:(SEL)arg2 delay:(double)arg3 waitToFireUntilRequestsStop:(_Bool)arg4 callOnMainThread:(_Bool)arg5;	// IMP=0x0000000100004b9c
