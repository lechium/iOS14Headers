...
@class IDSDevice, NSArray, NSData, NSDate, NSString, NSUUID;
...
- (void).cxx_destruct;	// IMP=0x000000010005d0f8
...
- (id)description;	// IMP=0x000000010005cec8
- (id)initWithIDSDevice:(id)arg1;	// IMP=0x000000010005ca80
