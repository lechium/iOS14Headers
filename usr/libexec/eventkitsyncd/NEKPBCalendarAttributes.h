...
- (void).cxx_destruct;	// IMP=0x0000000100010b24
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010000fef8
- (unsigned long long)hash;	// IMP=0x000000010000f958
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000eff4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000e7f0
- (void)copyTo:(id)arg1;	// IMP=0x000000010000e0f0
- (void)writeTo:(id)arg1;	// IMP=0x000000010000dab0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010000daa8
- (id)dictionaryRepresentation;	// IMP=0x000000010000bafc
- (id)description;	// IMP=0x000000010000ba48
