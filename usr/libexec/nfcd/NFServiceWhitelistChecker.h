...
- (void).cxx_destruct;	// IMP=0x00000001000d21b8
...
- (id)description;	// IMP=0x00000001000d1e34
- (id)_stringFromISO15693AccessFilterList;	// IMP=0x00000001000d1c78
- (id)_stringFromArray:(id)arg1;	// IMP=0x00000001000d1ab4
...
- (id)getAppInfoDictionary;	// IMP=0x00000001000d1820
@property(readonly, copy, nonatomic) NSString *clientName;
- (unsigned int)validateISO15693TagAccessWithManufacturerCode:(unsigned long long)arg1;	// IMP=0x00000001000d16a8
- (unsigned int)validateISO15693TagAccessWithManufacturerCode:(unsigned long long)arg1 serialNumber:(id)arg2;	// IMP=0x00000001000d12cc
- (unsigned int)validateISO15693TagAcesssWithUID:(id)arg1;	// IMP=0x00000001000d11ac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000d1058
- (id)initWithConnection:(id)arg1 coreNFCConnection:(_Bool)arg2;	// IMP=0x00000001000d0ae0
- (id)initWithConnection:(id)arg1;	// IMP=0x00000001000d0ad0
- (void)_initISO7816PermissibleAIDListWithSecTask:(struct __SecTask *)arg1 infoPlist:(id)arg2;	// IMP=0x00000001000d090c
- (void)_initCoreNFCEntitlements:(id)arg1 secTask:(struct __SecTask *)arg2;	// IMP=0x00000001000d0654
- (_Bool)_isAIDStringValid:(id)arg1;	// IMP=0x00000001000d0314
- (void)_initTagSpecifier:(id)arg1 maximumFilterStringLength:(unsigned long long)arg2;	// IMP=0x00000001000cff30
- (void)_initISO15693TagSpecifier:(id)arg1;	// IMP=0x00000001000cff20
- (id)_createAccessDictionaryFromICCode:(id)arg1 serialNumber:(id)arg2 maximumFilterStringLength:(unsigned long long)arg3;	// IMP=0x00000001000cfbbc
- (id)_stringValueOfEntitlement:(id)arg1 secTask:(struct __SecTask *)arg2;	// IMP=0x00000001000cfb68
- (id)_arrayValueOfEntitlement:(id)arg1 secTask:(struct __SecTask *)arg2;	// IMP=0x00000001000cfb14
- (_Bool)_boolValueOfEntitlement:(id)arg1 secTask:(struct __SecTask *)arg2;	// IMP=0x00000001000cfaa8
- (void *)_copyValueOfEntitlement:(id)arg1 secTask:(struct __SecTask *)arg2;	// IMP=0x00000001000cf88c
