...
- (void).cxx_destruct;	// IMP=0x000000010002a0f0
...
- (id)initWithIdentifier:(id)arg1 forReason:(id)arg2 contextRelativePointerPosition:(id)arg3 displayUUID:(id)arg4 restrictingToPID:(int)arg5 invalidationBlock:(CDUnknownBlockType)arg6;	// IMP=0x0000000100029fb0
