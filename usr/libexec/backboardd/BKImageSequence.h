...
- (void).cxx_destruct;	// IMP=0x000000010002d62c
...
- (void)_loadAllImages;	// IMP=0x000000010002d570
- (struct CGImage *)_imageAtIndex:(long long)arg1;	// IMP=0x000000010002d374
- (id)_idiomSuffix;	// IMP=0x000000010002d2c8
- (struct CGImage *)_createImageForIndex:(unsigned long long)arg1 basename:(id)arg2 scale:(double)arg3 idiom:(id)arg4 bundle:(id)arg5;	// IMP=0x000000010002cfcc
- (id)allImages;	// IMP=0x000000010002cf98
- (struct CGImage *)imageAtIndex:(long long)arg1;	// IMP=0x000000010002cf8c
- (id)initWithBasename:(id)arg1 bundle:(id)arg2 imageCount:(long long)arg3 scale:(double)arg4;	// IMP=0x000000010002ce54
