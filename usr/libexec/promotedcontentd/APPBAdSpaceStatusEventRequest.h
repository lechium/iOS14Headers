...
@interface APPBAdSpaceStatusEventRequest : PBRequest <NSCopying>
{
...
+ (id)options;	// IMP=0x000000010008e1d8
- (void).cxx_destruct;	// IMP=0x0000000100090a20
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100090610
- (unsigned long long)hash;	// IMP=0x0000000100090394
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100090040
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010008fd60
- (void)copyTo:(id)arg1;	// IMP=0x000000010008faf4
- (void)writeTo:(id)arg1;	// IMP=0x000000010008f8c8
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010008f8c0
- (id)dictionaryRepresentation;	// IMP=0x000000010008ec64
- (id)description;	// IMP=0x000000010008ebb0
...
- (int)StringAsStatusCode:(id)arg1;	// IMP=0x000000010008e690
- (id)statusCodeAsString:(int)arg1;	// IMP=0x000000010008e4a4
