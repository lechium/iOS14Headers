...
- (void).cxx_destruct;	// IMP=0x0000000100256528
...
- (void)cancel;	// IMP=0x000000010025642c
- (void)resolve;	// IMP=0x0000000100255fbc
- (void)parseResults:(const char *)arg1 port:(unsigned short)arg2 txtLen:(unsigned short)arg3 txtRecord:(const char *)arg4 interface:(unsigned int)arg5;	// IMP=0x0000000100255c04
- (void)notifyClient:(int)arg1;	// IMP=0x0000000100255bb4
- (void)dealloc;	// IMP=0x0000000100255b68
- (id)initWithName:(id)arg1 type:(id)arg2 domain:(id)arg3 path:(id)arg4 timeout:(_Bool)arg5;	// IMP=0x0000000100255a28
