...
- (id)userInfoForNewProtocol;	// IMP=0x000000010005a2f4
- (id)userInfoForOldProtocol;	// IMP=0x000000010005a1fc
- (id)userInfoForNoCommunincation;	// IMP=0x000000010005a104
- (id)userInfoForNoPasscode;	// IMP=0x000000010005a00c
- (id)userInfoForNoWristDetection;	// IMP=0x0000000100059f14
- (id)userInfoForNoWristDetectionNoPasscode;	// IMP=0x0000000100059e1c
- (id)userInfoCompanionViewNotSyncing;	// IMP=0x0000000100059d24
- (id)userInfoForWatchLocked;	// IMP=0x0000000100059c2c
- (id)userInfoForNotCloudPaired;	// IMP=0x0000000100059b7c
- (id)userInfoForMacNotSignedIn;	// IMP=0x0000000100059a84
- (id)userInfoForWatchNotSignedIn;	// IMP=0x000000010005998c
- (id)userInfoForMissingLTK;	// IMP=0x0000000100059894
- (id)userInfoForInternetSharing;	// IMP=0x000000010005979c
- (id)userInfoForKeychainMismatch;	// IMP=0x00000001000596a4
- (id)userInfoForiPhoneNeedsUnlock;	// IMP=0x00000001000595ac
- (void)transport:(id)arg1 didReceiveMessageACKForIdentifier:(id)arg2;	// IMP=0x0000000100059398
- (void)transport:(id)arg1 didReceivePayload:(id)arg2 type:(unsigned short)arg3 deviceID:(id)arg4;	// IMP=0x0000000100059088
- (void)sendCreateEscrowSecretWithStepData:(id)arg1 sessionID:(unsigned int)arg2;	// IMP=0x0000000100058cac
- (void)sendSetupRequest;	// IMP=0x00000001000587b0
- (void)handleSuccessfulPairing;	// IMP=0x0000000100058148
- (void)handleSetupCreateRecord:(id)arg1;	// IMP=0x0000000100057a08
- (void)handleEscrowSessionRequest;	// IMP=0x0000000100057090
- (void)handleSetupSessionCreated:(id)arg1;	// IMP=0x000000010005675c
- (void)handleKeyDeviceLocked;	// IMP=0x0000000100056650
- (_Bool)ltkHashMatches;	// IMP=0x0000000100056528
- (void)handleLTKTimerFired;	// IMP=0x0000000100056284
- (void)invalidateLTKTimer;	// IMP=0x00000001000561ac
- (void)restartLTKTimer;	// IMP=0x0000000100055f9c
- (void)notifyDelegateKeyDeviceIsLocked;	// IMP=0x0000000100055ef8
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x0000000100055788
- (_Bool)validatePasscode:(id)arg1;	// IMP=0x0000000100055608
- (void)handleTimerFired;	// IMP=0x0000000100055420
- (id)generatedError;	// IMP=0x00000001000552c4
- (void)invalidate;	// IMP=0x00000001000551b4
- (void)onqueue_updateForCloudPairing;	// IMP=0x0000000100055148
- (void)updateForCloudPairing;	// IMP=0x00000001000550bc
- (void)onqueue_cancel;	// IMP=0x0000000100054f8c
- (void)cancel;	// IMP=0x0000000100054f00
- (void)onqueue_start;	// IMP=0x00000001000548e0
- (void)start;	// IMP=0x0000000100054854
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x0000000100054490
