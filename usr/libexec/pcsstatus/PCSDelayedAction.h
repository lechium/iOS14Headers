...
- (void).cxx_destruct;	// IMP=0x0000000100011b58
...
- (void)trigger;	// IMP=0x00000001000119c0
- (void)setHoldTransaction:(_Bool)arg1;	// IMP=0x0000000100011928
- (void)run;	// IMP=0x0000000100011918
- (void)setAction:(CDUnknownBlockType)arg1;	// IMP=0x00000001000118d4
- (id)initWithDelay:(unsigned long long)arg1 operationQueue:(id)arg2;	// IMP=0x0000000100011508
