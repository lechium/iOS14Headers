...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001002ec060
- (unsigned long long)hash;	// IMP=0x00000001002ebad8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001002eb6f8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001002eb330
- (void)copyTo:(id)arg1;	// IMP=0x00000001002eafa4
- (void)writeTo:(id)arg1;	// IMP=0x00000001002eac38
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001002eac30
- (id)dictionaryRepresentation;	// IMP=0x00000001002e9560
- (id)description;	// IMP=0x00000001002e94e0
...
- (int)StringAsOnsetReason:(id)arg1;	// IMP=0x00000001002e92f0
- (id)onsetReasonAsString:(int)arg1;	// IMP=0x00000001002e925c
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00000001002e8688
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00000001002e836c
