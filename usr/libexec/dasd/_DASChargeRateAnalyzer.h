...
- (void).cxx_destruct;	// IMP=0x000000010001439c
...
- (void)analyzeValues:(id)arg1 currentContext:(id)arg2;	// IMP=0x0000000100013e78
- (double)getReferenceChargeRateForContext:(id)arg1 reader:(id)arg2;	// IMP=0x0000000100013ce4
- (void)recordValue;	// IMP=0x0000000100013c34
- (void)stop;	// IMP=0x0000000100013bc8
- (void)start;	// IMP=0x0000000100013b38
- (id)initWithQueueLimit:(unsigned long long)arg1 reader:(id)arg2 monitoringInterval:(unsigned long long)arg3 analyzeToMonitorRatio:(unsigned long long)arg4;	// IMP=0x00000001000138e0
