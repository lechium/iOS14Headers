...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012479c
- (void).cxx_destruct;	// IMP=0x0000000100124f44
...
- (unsigned long long)hash;	// IMP=0x0000000100124c20
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100124b38
