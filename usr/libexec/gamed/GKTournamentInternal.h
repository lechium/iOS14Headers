...
+ (id)defaultCustomTournamentForTournamentDefinition:(id)arg1;	// IMP=0x00000001000ee238
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000edecc
- (void).cxx_destruct;	// IMP=0x00000001000ee734
