...
+ (id)metadataForBundleURL:(id)arg1;	// IMP=0x000000010008ac88
...
- (id)bundleURL;	// IMP=0x000000010008ae80
...
- (void)dealloc;	// IMP=0x000000010008ad60
- (id)initWithBundleID:(id)arg1;	// IMP=0x000000010008ac48
- (id)initWithProxy:(id)arg1;	// IMP=0x000000010008abe8
