...
+ (id)displayNameForEnvironment:(long long)arg1;	// IMP=0x0000000100078374
+ (id)hostNameForEnvironment:(long long)arg1;	// IMP=0x0000000100078348
+ (id)shared;	// IMP=0x0000000100077278
...
- (void)removeOverrideForKey:(id)arg1;	// IMP=0x0000000100077738
- (void)setStringValue:(id)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x0000000100077720
- (id)stringValueForKey:(struct __CFString *)arg1 defaultValue:(id)arg2;	// IMP=0x00000001000776f0
- (void)setTimeInterval:(double)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x0000000100077694
- (double)timeIntervalForKey:(struct __CFString *)arg1 defaultValue:(double)arg2;	// IMP=0x0000000100077650
- (void)setUnsignedIntegerValue:(long long)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x00000001000775f4
- (long long)unsignedIntegerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x00000001000775b0
- (void)setIntegerValue:(long long)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x0000000100077554
- (long long)integerValueForKey:(struct __CFString *)arg1 defaultValue:(long long)arg2;	// IMP=0x0000000100077510
- (void)setBooleanValue:(_Bool)arg1 forKey:(struct __CFString *)arg2;	// IMP=0x00000001000774b0
- (_Bool)booleanValueForKey:(struct __CFString *)arg1;	// IMP=0x00000001000774a0
- (_Bool)booleanValueForKey:(struct __CFString *)arg1 defaultValue:(_Bool)arg2;	// IMP=0x000000010007745c
- (id)preferencesValueForKey:(id)arg1;	// IMP=0x000000010007740c
- (void)_didWriteKey:(struct __CFString *)arg1;	// IMP=0x00000001000773e4
- (void)synchronize;	// IMP=0x00000001000773a8
- (void)invalidate;	// IMP=0x0000000100077398
- (_Bool)isInternalBuild;	// IMP=0x000000010007731c
- (void)dealloc;	// IMP=0x0000000100077230
- (id)init;	// IMP=0x0000000100077224
- (id)initWithoutUIKitNotifications;	// IMP=0x00000001000771a4
- (id)initWithUIKitNotifications;	// IMP=0x0000000100077198
- (void)profileConnectionDidReceiveEffectiveSettingsChangedNotification:(id)arg1 userInfo:(id)arg2;	// IMP=0x00000001000dc1ac
- (id)valueRestrictionForKey:(id)arg1;	// IMP=0x00000001000dc170
- (_Bool)restrictionEnabledForKey:(id)arg1;	// IMP=0x00000001000dc128
