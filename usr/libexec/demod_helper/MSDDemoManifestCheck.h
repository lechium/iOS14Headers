...
+ (id)sharedInstance;	// IMP=0x000000010000e3c8
- (void).cxx_destruct;	// IMP=0x0000000100011544
...
- (_Bool)checkFileForEntitlements:(id)arg1 forCorrespondingManifestEntry:(id)arg2;	// IMP=0x0000000100010f1c
- (void)registerEntitlementNotificationHandler;	// IMP=0x0000000100010cf8
- (_Bool)runAppLayoutSecurityCheck:(id)arg1;	// IMP=0x0000000100010328
- (_Bool)runSecurityChecksForSection:(id)arg1 dataType:(id)arg2;	// IMP=0x000000010000fad8
- (_Bool)runSecurityCheck;	// IMP=0x000000010000f2f4
- (_Bool)secureManifestCheckForSegmentedManifest:(id)arg1;	// IMP=0x000000010000f19c
- (_Bool)secureManifestCheckForUnsegmentedManifest:(id)arg1;	// IMP=0x000000010000efac
- (_Bool)unsegmentedToSegmentedWithRigorousFlag:(id)arg1;	// IMP=0x000000010000e890
- (id)init;	// IMP=0x000000010000e434
