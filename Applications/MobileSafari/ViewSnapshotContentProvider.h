...
- (void).cxx_destruct;	// IMP=0x00000001001763c4
...
- (struct CGRect)snapshotContentRectInBounds:(struct CGRect)arg1;	// IMP=0x0000000100176308
- (id)initWithContentView:(id)arg1;	// IMP=0x0000000100176280
