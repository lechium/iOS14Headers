...
- (id)reflectedStringForUserTypedString:(id)arg1;	// IMP=0x0000000100065c00
- (void)configureCompletionTableViewCell:(id)arg1 forCompletionList:(id)arg2;	// IMP=0x0000000100065b74
- (id)completionTableViewCellReuseIdentifier;	// IMP=0x0000000100065b68
- (id)completionTableViewCellForCompletionList:(id)arg1;	// IMP=0x0000000100065af8
- (void)auditAcceptedCompletionWithRank:(unsigned long long)arg1;	// IMP=0x0000000100065af4
- (void)acceptCompletionWithActionHandler:(id)arg1;	// IMP=0x0000000100065a5c
