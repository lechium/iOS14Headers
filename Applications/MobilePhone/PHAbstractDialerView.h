...
- (id)senderIdentityMenuForDialerField:(id)arg1 selectedSenderIdentity:(id)arg2;	// IMP=0x0000000100070410
- (void)dialerField:(id)arg1 stringWasPasted:(id)arg2;	// IMP=0x000000010007037c
- (void)dialerLCDFieldTextDidChange:(id)arg1;	// IMP=0x0000000100070308
- (void)dealloc;	// IMP=0x00000001000702ac
