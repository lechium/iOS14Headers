...
- (void).cxx_destruct;	// IMP=0x00000001000b2b54
...
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000b27a0
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000b2460
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000b2140
