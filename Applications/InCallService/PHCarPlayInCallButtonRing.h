...
- (void).cxx_destruct;	// IMP=0x0000000100049ef4
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000100049e94
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000100049bb8
