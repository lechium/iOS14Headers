...
+ (void)initialize;	// IMP=0x00000001000022b4
@property(readonly, nonatomic) long long currentKeyboardModifierFlags;
- (void)handleKeyUIEvent:(id)arg1;	// IMP=0x0000000100002500
- (id)newSharedSiteMetadataManager;	// IMP=0x00000001000023d4
- (void)applicationDidFinishLaunching:(id)arg1;	// IMP=0x0000000100002368
