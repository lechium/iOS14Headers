...
- (void).cxx_destruct;	// IMP=0x000000010003f788
@property(nonatomic) __weak id <HSSetupStepDelegate> delegate; // @synthesize delegate=_delegate;
- (void)viewControllerWillAppear:(id)arg1;	// IMP=0x000000010003f6e4
- (void)configuratorDidFinish:(id)arg1;	// IMP=0x000000010003f684
- (void)configuratorDidUpdateViewController:(id)arg1;	// IMP=0x000000010003f620
@property(readonly, nonatomic) long long setupState;
- (id)initWithSetupStepDelegate:(id)arg1 initialViewController:(id)arg2;	// IMP=0x000000010003f590
