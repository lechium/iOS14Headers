...
- (void).cxx_destruct;	// IMP=0x0000000100072828
...
- (void)viewDidLoad;	// IMP=0x000000010007275c
@property(readonly, nonatomic) unsigned long long popupType;
@property(readonly, nonatomic) long long setupState;
- (id)initWithSetupAccessoryDescription:(id)arg1;	// IMP=0x0000000100072738
- (id)initWithPopupDelegate:(id)arg1 setupAccessoryDescription:(id)arg2;	// IMP=0x00000001000720b4
