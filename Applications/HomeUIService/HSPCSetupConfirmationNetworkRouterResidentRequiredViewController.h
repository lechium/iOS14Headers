...
@interface HSPCSetupConfirmationNetworkRouterResidentRequiredViewController : HUPCImageContentController <HSSetupStep, HFSetupPairingPopup>
{
...
- (void).cxx_destruct;	// IMP=0x000000010002f064
...
- (id)initWithSetupAccessoryDescription:(id)arg1;	// IMP=0x000000010002efdc
- (id)initWithPopupDelegate:(id)arg1 setupAccessoryDescription:(id)arg2;	// IMP=0x000000010002eb00
