...
@interface ServiceSKUIRedeemViewController : SKUIRedeemViewController <ServiceAccountPageEmbedded>
{
...
- (void)dismissViewControllerAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010000be80
- (void)dismissAnimated:(_Bool)arg1;	// IMP=0x000000010000be04
