...
@interface _TtC8AppStore14BaseLockupView : UIView
{
    ...
    MISSING_TYPE *ordinalLabel;	// 16 = 0x10
    ...
    MISSING_TYPE *offerLabelPresenter;	// 72 = 0x48
}

- (void).cxx_destruct;	// IMP=0x000000010001d980
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010001d4f8
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010001d4d8
