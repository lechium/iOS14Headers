...
- (void).cxx_destruct;	// IMP=0x00000001002d1a04
@property(nonatomic, readonly) _TtC8AppStore16DynamicTypeLabel *accessibilityTextLabel;
- (void)accessoryDidActionWithSender:(id)arg1;	// IMP=0x00000001002d1914
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001002d173c
- (void)layoutSubviews;	// IMP=0x00000001002d15f4
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001002d1090
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001002d1070
