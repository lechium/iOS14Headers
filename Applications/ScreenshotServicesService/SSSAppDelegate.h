...
- (void).cxx_destruct;	// IMP=0x000000010001d994
@property(nonatomic) _Bool didLaunchSuspended; // @synthesize didLaunchSuspended=_didLaunchSuspended;
@property(retain, nonatomic) UIWindow *window; // @synthesize window=_window;
- (void)application:(id)arg1 didFinishLaunchingSuspendedWithOptions:(id)arg2;	// IMP=0x000000010001d840
- (_Bool)application:(id)arg1 didFinishLaunchingWithOptions:(id)arg2;	// IMP=0x000000010001d800
@property(readonly, nonatomic) SSSViewControllerManager *viewControllerManager;
- (void)_setUpDevelopmentUI;	// IMP=0x000000010001d74c
- (_Bool)_shouldSetUpDevelopmentUI;	// IMP=0x000000010001d710
