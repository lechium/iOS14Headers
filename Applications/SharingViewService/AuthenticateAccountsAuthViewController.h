...
@interface AuthenticateAccountsAuthViewController : SVSBaseViewController
{
...
- (void).cxx_destruct;	// IMP=0x0000000100047428
- (void)showWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2;	// IMP=0x0000000100047234
- (void)_handlePINEntered:(id)arg1;	// IMP=0x00000001000471a8
- (void)_handleKeyboardWillShow:(id)arg1;	// IMP=0x0000000100046e80
- (void)handleDismissButton:(id)arg1;	// IMP=0x0000000100046dcc
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000100046cec
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000001000469d4
