...
- (void).cxx_destruct;	// IMP=0x000000010005af74
- (void)showWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2;	// IMP=0x000000010005ad80
- (void)_handlePINEntered:(id)arg1;	// IMP=0x000000010005ac40
- (void)_handleKeyboardWillShow:(id)arg1;	// IMP=0x000000010005a8d4
- (void)handleDismissButton:(id)arg1;	// IMP=0x000000010005a81c
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000010005a73c
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010005a4a0
