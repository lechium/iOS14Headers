...
- (void).cxx_destruct;	// IMP=0x000000010004e2cc
...
- (void)insertText:(id)arg1;	// IMP=0x000000010004e0d0
- (void)deleteBackward;	// IMP=0x000000010004e034
- (_Bool)canBecomeFirstResponder;	// IMP=0x000000010004e02c
@property(nonatomic) long long autocorrectionType;
@property(nonatomic) long long autocapitalizationType;
- (void)_updateLabels;	// IMP=0x000000010004dc54
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x000000010004dbcc
